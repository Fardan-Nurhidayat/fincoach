...
export default function KontakForm() {
  ...
  return (
    <section id="kontak" className="text-gray-700 body-font bg-white py-24">
          ...
          >
            <div className="bg-gray-100 rounded-lg overflow-hidden h-[400px] relative">
              ...
              <div className="relative z-10 bg-white bg-opacity-90 p-6 shadow-md max-w-xs mx-auto md:mx-0">
                ...
                <p className="leading-relaxed">info@financeapp.id</p>
                <h3 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">
                  TELEPON
                </h3>
                <p className="leading-relaxed">+62 000 0000 0000</p>
              </div>
            </div>
          </motion.div>
            ...
            >
              ...
              <div className="relative mb-4">
                ...
                <textarea
                  ...
                  required
                  rows="4"
                  className="w-full bg-white rounded border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 text-base outline-none text-gray-700 py-2 px-3 resize-none transition-colors duration-200 ease-in-out"
                ></textarea>
              </div>
              <button
                type="submit"
