...
const fiturList = [
  {
    ...
    desc: "Otomatis membagi pendapatan bulanan tergantung profil resiko dengan membagi menjadi kebutuhan, tabungan, dan investasi",
    icon: (
      <path
        strokeLinecap='round'
  ...
  },
  {
    ...
    desc: "Prediksi Harga saham oleh AI.",
    icon: (
      <path
        strokeLinecap='round'
        strokeLinejoin='round'
  ...
  {
    title: "Expense,Savings and investment tracking",
    desc: "Expense,Savings and investment Tracking.",
    icon: (
      <path
        strokeLinecap='round'
        strokeLinejoin='round'
