    ...
    <div
      ...
      <Dialog>
        <DialogTrigger asChild>
          <button className='px-4 py-2 mt-4 rounded-lg bg-white font-semibold cursor-pointer text-red-500 transition-all duration-300 shadow-lg group-hover:shadow-xl'>
            {triggerText}
          </button>
        </DialogTrigger>
